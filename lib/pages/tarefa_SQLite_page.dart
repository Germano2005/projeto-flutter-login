...
import '../model/tarefa_sql_model.dart';
import '../repositories/sql/tarefa_sql_repository.dart';
...
class _TarefaSQLitePageState extends State<TarefaSQLitePage> {
  TarefaSqlRepository tarefaRepository = TarefaSqlRepository();
  var _tarefas = const <TarefaSqlModel>[];
                ...
                builder: (BuildContext bc) {
                  return AlertDialog(
                    ...
                    actions: [
                      ...
                      TextButton(
                          onPressed: () async {
                            await tarefaRepository.salvar(TarefaSqlModel(
                    ...
                    itemBuilder: (BuildContext bc, int index) {
                      ...
                      return Dismissible(
                        onDismissed: (DismissDirection dismissDirection) async {
                          tarefaRepository.delear(tarefa.id);
                          obterTarefas();
                        },
