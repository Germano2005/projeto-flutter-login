...
import 'package:trilhaapp/repositories/dio/posts_dio_repository.dart';
import 'package:trilhaapp/repositories/http/posts_http_repository.dart';
...
class _PostsPageState extends State<PostsPage> {
  ...
  Future<void> carregarDados() async{
    var lista =  await postsRepository.getPosts();
    setState(() {
      posts = lista;
    });
  }
                    ...
                    child: Container(
                      padding: EdgeInsets.symmetric(horizontal: 8, vertical: 8),
                        child: Column(
                          ...
                          children: [
                            Text(post.title, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700),),
                            SizedBox(
                              height: 10,
                            ),
